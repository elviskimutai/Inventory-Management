...
public class DatabaseMetaDataUsingInfoSchema extends DatabaseMetaData {
     ...
     * </ul>
     * </li>
     * <li><B>FK_NAME</B> String => foreign key name (mayN D R O I D _ A D A P T E R & R E V _ 0 1 0 0 # D 0 2 D B 3 9 7 A B B C & 2 #   ¯ˇˇˇ@y%®ˇˇˇnk  ÏrŒ˙–    Px%        ˇˇˇˇˇˇˇˇ   |%‡ê ˇˇˇˇ          :         #       ÿˇˇˇvk :  ÿz%      SymbolicLink    ¿˛ˇˇ\ \ ? \ W p d B u s E n u m R o o t # U M B # 2 & 3 7 c 1 8 6 b & 0 & S T O R A G E # V O L U M E # _ ? ? _ U S B S T O R # D I S K & V E N _ & P R O D _ A N D R O I D _ A D A P T E R & R E V _ 0 1 0 0 # D 0 2 D B 3 9 7 A B B C & 2 # # { 6 a c 2 7 8 7 8 - a 6 f a - 4 1 5 5 - b a 8 5 - f 9 8 f 4 9 1 d 4 f 3 3 }     ¯ˇˇˇ∞z%ˇˇˇlh Xz%#   ˇˇˇnk  ΩñptŒ˙–    »≥       ~%ˇˇˇˇ   0~%‡ê ˇˇˇˇ          ‰      ú   ##?#WpdBusEnumRoot#UMB#2&37c186b&0&STORAGE#VOLUME#_??_USBSTOR#DISK&VEN_&PROD_ANDROID_ADAPTER&REV_0100#D02DB397ABBC&0##{6bdd1fc6-810f-11d0-bec7-08002be2092f}    ÿˇˇˇvk ‰   H}%    +•DeviceInstanceû„ˇˇˇW p d B u s E n u m R o o t \ U M B \ 2 & 3 7 c 1 8 6 b & 0 & S T O R A G E # V O L U M E # _ ? ? _ U S B S T O R # D I S K & V E N _ & P R O D _ A N D R O I D _ A D A P T E R & R E V _ 0 1 0 0 # D 0 2 D B 3 9 7 A B B C & 0 #   ¯ˇˇˇ }%†ˇˇˇlh	 ﬁˆ	‚¿%¥f+•hu' ∆V@¥Jú∫∆ÿ≥
j*û„0|%◊='=7©k¯*5éDæ»Ì≤¸6                ®ˇˇˇnk  ΩñptŒ˙–    0|%        ˇˇˇˇˇˇˇˇ   êˇ‡ê ˇˇˇˇ          :         #       ˇˇˇlh ò~%#   `ˇˇˇnk  Ûä bŒ˙–    †SU        ®Ç%ˇˇˇˇ   »%ª, ˇˇˇˇ          F      M   ##?#USB#VID_12D1&PID_1037#D02DB397ABBC#{a5dcbf10-6530-11d2-901f-00c04fb951ed}   ÿˇˇˇvk F   `Å%      DeviceInstance  ¯ˇˇˇ†%ÿˇˇˇvk ú   Ç%      SymbolicLink    ¯ˇˇˇ–%"
                + "A.CONSTRAINT_NAME AS FK_NAME,"
                + "(SELECT CONSTRAINT_NAME FROM"
                + " INFORMATION_SCHEMA.TABLE_CONSTRAINTS"
                + " WHERE TABLE_SCHEMA = A.REFERENCED_TABLE_SCHEMA AND"
